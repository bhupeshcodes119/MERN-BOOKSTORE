...
const BookDetailPage = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success("Book deleted succwssfully");
      navigate("/");
    } catch (error) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.error("Failed to upadate book");
    } finally {
      setSaving(false);
    }
  };
        ...
        <div className='max-w-2xl mx-auto'>
          ...
          <div className='card bg-base-100 shadow-lg'>
            <div className='card-body'>
              ...
              {/*PUBLISH YEAR*/}
              <div className='form-control md-6'>
                <label className='label'>
                  <span className='label-text'>Publish Year</span>
                </label>
                <input type="text" placeholder='Book Author' className='input input-bordered' value={book.publishYear} onChange={(e) => setBook({ ...book, publishYear: e.target.value })} />
              </div>
              {/*ACTION*/}
